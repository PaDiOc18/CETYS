...
namespace TiendaFinalDonChapoICC
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Inicializar los descuentos
            for (int i = 0; i < aparatos.Length; i++)
            {
                aparatos[i].stat = "No Aplica";
            }
            ...
            {
                int w = NumRan.Next(0, 60);
                double h = descuentos[NumRan.Next(0, 4)].PorcentajeDescuento;
                if (aparatos[w].stat == "No Aplica")
                {
                    clavesdes = clavesdes + 1;
                    aparatos[w].stat = "Aplica";
                    descuentos[i].ClaveDescuento = clavesdes;
                    Console.WriteLine("Clave: {0}", descuentos[i].ClaveDescuento);
                    Console.WriteLine("Porcentaje de Descuento: {0}%",  h * 100);
                    aparatos[w].Desc = h;
            ...
            //Imprimir los descuentos que tengan los productos 
            for (int i = 0; i < aparatos.Length; i++)
            {
                if (aparatos[i].stat == "Aplica")
                {
                    ...
                    Console.WriteLine("Descuento: " + aparatos[i].stat );
                    Console.WriteLine("Total de descuento: $" + (aparatos[i].Desc * aparatos[i].Precio).ToString("##.###.##"));
                    Console.WriteLine("Precio Total: $" + (aparatos[i].Precio - (aparatos[i].Desc * aparatos[i].Precio)).ToString("##.###.##"));
                    Console.WriteLine("");
                    Console.ReadKey();
                }
            }
                ...
                switch (NumCajero)
                {
                    case 1:
                        ...
                        if (Usuario == cajero[0].usuario && Contra == cajero[0].contrasena)
                        {
                            ...
                            int NumUsuario = 0; int NumVenta = 0;
                            double Final = 0; double SUPERFINAL = 0;
                            bool nuevousu = true;
                            while (nuevousu == true)
                            {
                                ...
                                {
                                    NumVenta = NumVenta + 1;
                                    Console.WriteLine("Ingrese el ID del producto a vender: ");
                                    int AIDI = int.Parse(Console.ReadLine());
                                    Console.WriteLine("Ingrese la cantidad del prodcuto");
                                    int Ca = int.Parse(Console.ReadLine());
                                    Console.WriteLine("Fecha de venta: (dd/mm/aa)");
                                    string Fe = Console.ReadLine();
                                    double hola = 0;
                                    hola = Ventas1(NumUsuario, NumVenta, aparatos[AIDI].Precio, Ca, cajero[0].Nombre,
                                        AIDI, aparatos[AIDI].DES, aparatos[AIDI].CantidadProducto, aparatos[AIDI].stat,
                                        Fe, aparatos[AIDI].Desc);
                                    Final = Final + hola;
                                    SUPERFINAL = SUPERFINAL + Final;
                                    Console.WriteLine("El total es: $" + hola.ToString("##,###.##"));
                                    hola = 0;
                                    Console.WriteLine("Quieres vender otro producto?");
                                    Console.WriteLine("1- Si            2- No");
                                    int f; f = int.Parse(Console.ReadLine());
                                    if (f == 1)
                                    {
                                        estadoventa = true;
                                        Console.Clear();
                                    ...
                                    else
                                    {
                                        ...
                                        Console.WriteLine("Atendió al usuario: #" + NumUsuario);
                                        Console.WriteLine("Vendió: " + Final.ToString("##,###.##"));
                                        Console.ReadKey();
                                        estadoventa = false;
                                        Final = 0;
                                ...
                                Console.WriteLine("Quieres Atender a otro sujeto?");
                                Console.WriteLine("1- Si            2- No");
                                int z; z = int.Parse(Console.ReadLine());
                                if (z == 1)
                                {
                                    nuevousu= true;
                                    Console.Clear();
                                ...
                                {
                                    Console.WriteLine("Vendedor: " + cajero[0].Nombre);
                                    Console.WriteLine("Vendió: " + SUPERFINAL.ToString("##,###.##"));
                                    SUPERFINAL = 0;
                                    Console.ReadKey();
                                    nuevousu = false;
        ...
        static double Ventas1(int NumeroUsuario, int NumeroDeVenta ,double Precio, int CantidadVendido, string Vendedor,
            int ClavePro, string Descripcion, int CantidadDeProducto, string descuentoexiste, string FechaVenta, double Descuento)
        {
            double TotalUsuario = 0;

                Console.WriteLine("La clave del producto vendido es: " + ClavePro);
                Console.WriteLine("La clave de venta es: " + NumeroDeVenta);
                Console.WriteLine("El producto vendido es " + Descripcion);
                if (CantidadDeProducto >= CantidadVendido)
                {
                    Console.WriteLine("La cantidad vendida fue: " + CantidadVendido);
                    CantidadDeProducto = CantidadDeProducto - CantidadVendido;
                    if (descuentoexiste == "No Aplica")
                    {
                        Console.WriteLine("Precio: $" + Precio.ToString("##,###.##"));
                        Console.WriteLine("Precio + IVA: " + (Precio*1.16).ToString("##,###.##"));
                        double Total = (Precio * 1.16) * CantidadVendido;                       
                        TotalUsuario = TotalUsuario + Total;
                    }
                    else
                    {
                        Console.WriteLine("Precio: $" + Precio.ToString("##,###.##"));
                        Console.WriteLine("Precio + IVA: " + (Precio * 1.16).ToString("##,###.##"));
                        double Total = (Precio * 1.16) * Descuento;
                        Console.WriteLine("El descuento es: $" + Total.ToString("##,###.##"));
                        Total = (Precio * 1.16) - Total;
                        Console.WriteLine("El Precio Total es: $" + Total.ToString("##,###.##"));
                        TotalUsuario = TotalUsuario + Total; 
                    }
                }
                else
                {
                    Console.WriteLine("El producto es insuficiente");
                    Console.ReadKey();
                }
